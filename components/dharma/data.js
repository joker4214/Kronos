...
export const TEAM = [
  ...
  },
  {
    ...
    roleAccent: true,
    photo: 'mathew.jpg',
    bio: "Shopify Store Designer & Growth Marketer. I design beautiful Shopify stores that people love to shop on, and I market them so they actually make money \u2014 whether you're starting from zero or ready to scale, I'll handle the design, ads, and strategy so you can focus on your business.",
  ...
  },
  {
    ...
    roleAccent: true,
    photo: 'salman.jpg',
    bio: "Shopify Store Designer with over 3 years of experience helping businesses build professional, high-converting Shopify stores. Specializes in modern, mobile-friendly, conversion-focused stores \u2014 custom store design, homepage customization, product page optimization, trust badges, announcement bars, custom sections, landing pages, WhatsApp integration, review sections, policy pages, and other Shopify customizations.",
    contacts: [
...
// Interactive Style Picker (/style-picker) — six curated color+font
// "looks" a prospect can preview live before ever talking to us. Price
// values are sample product price-tag previews only (demonstrating how a
// price badge renders in that palette), NOT a fee for the theme itself.
export const THEME_PACKAGES = [
  {
    id: 'warm',
    name: 'Warm',
    tagline: 'Handmade, with heart.',
    vibe: 'Cozy and inviting — makes a store feel like a warm welcome, not a transaction.',
    goodFit: 'Home goods, food, gifts, handmade brands',
    bg: '#FBEFE0',
    surface: '#F2DAB8',
    accent: '#C1552C',
    text: '#3A2A1D',
    ...
    font: 'fraunces',
    fontWeight: 700,
    products: ['Cozy Candle Set', 'Gift Bundle'],
  },
  {
    id: 'calming',
    name: 'Calming',
    tagline: 'Slow down. Breathe. Shop.',
    vibe: 'Soft and unhurried — built for stores rooted in trust, care, or self-care.',
    goodFit: 'Skincare, wellness, pet care, home spa',
    bg: '#E8F1EC',
    surface: '#D3E6DC',
    accent: '#4F7D74',
    text: '#1F332C',
    ...
    font: 'quicksand',
    fontWeight: 700,
    products: ['Calm Serum', 'Self-Care Kit'],
  },
  {
    id: 'energized',
    name: 'Energized',
    tagline: 'Move fast. Buy now.',
    vibe: 'Loud and fast-moving — built to grab attention and push urgency.',
    goodFit: 'Fitness, sports, drops and limited releases',
    bg: '#FAFAF8',
    surface: '#EFEFEA',
    accent: '#FF5A36',
    text: '#15161A',
    ...
    products: ['Training Kit', 'Recovery Set'],
  },
  {
    id: 'relaxed',
    name: 'Relaxed',
    tagline: 'Nothing to rush here.',
    vibe: 'Earthy and grounded — natural materials, no flash, no noise.',
    goodFit: 'Sustainable goods, apparel, outdoors',
    bg: '#EEE7D8',
    surface: '#E2D5BC',
    accent: '#86664A',
    text: '#362D20',
    ...
    font: 'fraunces',
    fontWeight: 400,
    products: ['Trail Tee', 'Everyday Tote'],
  },
  {
    id: 'luxe',
    name: 'Luxe',
    tagline: 'Quiet confidence.',
    vibe: 'Sophisticated and minimal — for a store that wants to feel expensive.',
    goodFit: 'Jewelry, beauty, premium and limited goods',
    bg: '#17181C',
    surface: '#212327',
    accent: '#C9A24B',
    text: '#EDE7DC',
    ...
    font: 'cormorant',
    fontWeight: 600,
    products: ['Signature Piece', 'Gift Edition'],
  },
  {
    id: 'playful',
    name: 'Playful',
    tagline: 'Made to make you smile.',
    vibe: 'Fun and expressive — big personality for pet, kids, and lifestyle brands.',
    goodFit: 'Pet stores, kids, novelty, lifestyle brands',
    bg: '#FFF7F2',
    surface: '#FFE1E8',
    accent: '#FF5FA2',
    text: '#241B2B',
